...
import { SlidersIcon, KeyIcon, CheckIcon, CopyIcon } from '@phosphor-icons/react';
      ...
      <div className="max-w-300 mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <p className="text-[15px] sm:text-[16px] text-[#878c99] max-w-160 leading-[1.58]">
          ...
          <div className="flex items-center gap-2 mt-4 md:mt-0">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-[13px] transition-colors cursor-pointer ${
                activeMode === 'ollama'
            ...
            >
              <KeyIcon className="w-3.5 h-3.5 text-[#9c9af2]" />
        ...
        {/* Code Box */}
        <div className="bg-[#121317] border border-[#272a2e] rounded-sm shadow-2xl overflow-hidden">
