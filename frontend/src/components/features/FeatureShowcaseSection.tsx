      ...
      <div className="max-w-300 mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap gap-2 mb-8 border-b border-[#272a2e] pb-3">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-sm text-[14px] font-['Geist'] transition-all cursor-pointer ${
              activeTab === 'quiz'
        ...
        <div className="bg-[#121317] border border-[#272a2e] rounded-sm p-6 sm:p-8 shadow-2xl">
          ...
          {activeTab === 'quiz' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-2 text-[14px] text-[#d7d9dd]">
                    <CheckCircleIcon className="w-4 h-4 text-[#a8ff53]" />
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#a8ff53] text-[#121317] font-medium text-[14px] rounded-sm hover:bg-[#b8ff70] cursor-pointer"
                  >
              ...
              <div className="lg:col-span-6 bg-[#1c1e21] border border-[#272a2e] rounded-sm p-5">
                ...
                <div className="space-y-2 mb-4">
                  <div className="p-2.5 bg-[#121317] border border-[#a8ff53] rounded-sm text-[13px] text-[#e5e7eb] flex items-center justify-between">
                    <span>A. Store high-dimensional embeddings for cosine similarity</span>
                    <CheckCircleIcon className="w-4 h-4 text-[#a8ff53]" />
                  </div>
                  <div className="p-2.5 bg-[#121317] border border-[#272a2e] rounded-sm text-[13px] text-[#878c99]">
                ...
                <div className="p-3 bg-[#121317]/80 border-l-2 border-[#a8ff53] text-[12px] text-[#878c99]">
                  <span className="text-[#a8ff53] font-medium">Explanation:</span> PgVector enables PostgresSQL to index and query vector embeddings at sub-50ms latency.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'flashcard' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-2 text-[14px] text-[#d7d9dd]">
                    <CheckCircleIcon className="w-4 h-4 text-[#9c9af2]" />
              ...
              <div className="lg:col-span-6 bg-[#1c1e21] border border-[#272a2e] rounded-sm p-6 text-center">
                <div className="text-[12px] font-['Geist_Mono'] text-[#9c9af2] mb-3">Deck: Spring AI Fundamentals</div>
                <div className="p-6 bg-[#121317] border border-[#3b3e45] rounded-sm mb-4 min-h-35 flex flex-col items-center justify-center">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  {[0, 1, 2, 3, 4, 5].map((q) => (
                    <button
                      key={q}
                      className="w-8 h-8 rounded-sm bg-[#121317] hover:bg-[#272a2e] border border-[#272a2e] text-[13px] font-['Geist_Mono'] text-[#e5e7eb] transition-colors"
                    >
                      {q}
                    </button>
                  ))}
          ...
          {activeTab === 'summary' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-2 text-[14px] text-[#d7d9dd]">
                    <CheckCircleIcon className="w-4 h-4 text-[#fa3abf]" />
              ...
              <div className="lg:col-span-6 bg-[#1c1e21] border border-[#272a2e] rounded-sm p-5 font-['Geist_Mono'] text-[12px]">
          ...
          {activeTab === 'podcast' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-2 text-[14px] text-[#d7d9dd]">
                    <CheckCircleIcon className="w-4 h-4 text-[#afec73]" />
              ...
              <div className="lg:col-span-6 bg-[#1c1e21] border border-[#272a2e] rounded-sm p-6">
